...
export default function SkillsSection() {
      ...
      <div  style={progressBar} className={classes.container}>
        <div id="container nav-tabs">
          ...
          <h3 style={{paddingTop:"50px"}}><b>Languages/Frameworks:</b></h3>
              ...
              <div ><img class="tile" onMouseOver={() => changeTechText("Bootstrap (A Popular User Interface Framework)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/bootstrap.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Bitbucket (Enterprise-level Repository Hosting Service)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/bitbucket.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Docker (Application Deployment Tool Using Containers)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/docker.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Github (Popular Git Repository Hosting Service)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/github.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Memcached (Memory-Chaching System for Decreasing Latency in DB-Driven Applications)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/memcached.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Material UI (A Popular React User Interface Framework)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/materialui.svg"}></img></div>
  {/*<div><img class="tile" onMouseOver={() => changeTechText("Kubernetes (An Open-Source Container Orchestration System For Deployment Automation)")} onMouseLeave={() => changeTechText("")} alt="" src={require("../../../assets/img/icons/kubernetes.png")}></img></div>*/}
              <div><img class="tile" onMouseOver={() => changeTechText("MongoDB (A Popular NoSQL Databse)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/mongo.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Postman (A Widely-Used Tool for API Testing)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/postman.png"}></img></div>
              <div><img class="tile" onMouseOver={() => changeTechText("Amazon Web Services (Amazon's Cloud Service)")} onMouseLeave={() => changeTechText("")} alt="" src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/aws.png"}></img></div>
              </div></div>  
