                ...
                <div className="row" style={{paddingLeft:"10%"}}>
                    <div className="social" style={social}>
                        <ul>
                            ...
                            <li><Tooltip TransitionComponent={Zoom} placement="top-end" title="Github" arrow><a href="https://https://github.com/tanishqsandhu"><img style={{ width: "55%", marginTop: "20%" }} src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/github.png"} alt="VSCO Logo" /></a></Tooltip></li>

                            <li><Tooltip TransitionComponent={Zoom} placement="top-end" title="VSCO" arrow><a href="https://vsco.co/tanishqsandhu/images"><img style={{ width: "55%", marginTop: "20%" }} src={"https://personalwebsiteimages.s3.us-east-2.amazonaws.com/vsco.png"} alt="VSCO Logo" /></a></Tooltip></li>
