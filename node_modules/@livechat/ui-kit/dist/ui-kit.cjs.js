...
var PersonIcon = function PersonIcon(props) {
  return React.createElement(Icon, props, React.createElement(Person, null));
};
...
var Image = function Image(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement("img", _extends({}, imgProps, {
...
var Avatar = function Avatar(props) {
  ...
  if (imgUrl) {
    child = React.createElement(Image, {
      src: imgUrl,
      className: embeddedImageStyle,
      alt: 'avatar'
    }, function (_ref) {
      var imageStatus = _ref.imageStatus;
      return imageStatus === 'failed' && React.createElement(PersonIcon, {
        className: embeddedImageStyle
      });
    });
  } else if (letter) {
